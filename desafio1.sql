...
VALUES(1, 'Soul For Us', '200', 'Walter Phoenix', 1, 'Envious', 1),
      ...
      (3, 'Dance With Her Own', '118',  'Walter Phoenix', 1, 'Envious', 1), 
      (4, 'Troubles Of My Inner Fire', '203', 'Walter Phoenix', 1, 'Exuberant', 2),
      (5, 'Time Fireworks', '153', 'Walter Phoenix', 1, 'Exuberant', 2),
      ...
      (9, 'She Knows', '247', 'Peter Strong', 4, 'Hallowed Steam', 3),
      ...
      (15, 'Let\'s Be Silly', '137', 'Lance Day', 3, 'Incandescent', 4),
      ...
      (18, 'Without My Streets', '178',  'Freedie Shannon', 2, 'Temporary Culture', 5), 
      ...
      (23, 'Young And Father', '202', 'Freedie Shannon', 2, 'Library of liberty', 6),
      ...
      (27, 'Honey, I\'m A Lone Wolf', '153', 'Tyler Isle', 5, 'Chained Down', 7),
      ...
      (31, 'I Know I Know', '120', 'Tyler Isle', 5, 'Cabinet of fools', 8),
      ...
      (35, 'I Ride Alone', '153', 'Tyler Isle', 5, 'No guarantees', 9),
      ...
      (40, 'You Make Me Feel So..', '87', 'Fog',6, 'Apparatus', 10); 
